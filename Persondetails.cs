...
namespace PersonStaffStudent
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Person[] people = {
                                new Person("Madhu", "Bangalore", "Karnataka", " fundamentals", 2010, 4500.0),
                                new Person("lasya", "Bangalore"," Karnataka", "Delhi Public school", 35000.0),
                                new Person("bhavan", "Bangalore", "Karnataka", "National Public school", 42000.0),
                                new Person("heamnth", "Hassan", "Karnataka", " fundamentals", 2012, 4750.0),
